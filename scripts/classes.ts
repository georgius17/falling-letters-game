...
class Menu {
    isButtonStartHoveredM: boolean;
    isButtonOptionsHoveredM: boolean;
    isOptionsDisplayedM: boolean;
    isEndMenuDisplayedM: boolean;
    ...
    showButton(isHovered: boolean, rect: Rect, text: string) {
    ...
    processHover(p) {
        ...
        this.isButtonStartHoveredM = this.isCurrentButtonHover(
            p, 
            createButtonRect(0), 
            (!this.isEndMenuDisplayedM ? 'Start game' : 'Restart'), 
            this.isButtonStartHoveredM
        );
        this.isButtonOptionsHoveredM = this.isCurrentButtonHover(
            p, 
            createButtonRect(buttonsGap), 
            (!this.isEndMenuDisplayedM ? 'Options' : 'Back to menu'), 
            this.isButtonOptionsHoveredM
        );
    }
}
